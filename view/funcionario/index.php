    ...
    <div class="row justify-content-center">
        <div class="row">
                ...
                <table class="table table-striped">
                    ...
                    <?php foreach ($funcionarios as $funcionario) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="router.php?c=funcionario&a=show&id=<?=$funcionario->id ?>" class="btn btn-primary" role="button">Show</a>
            ...
            <div class="col-12 mt-5">
                ...
                <a href="router.php?c=funcionario&a=create" class="btn btn-primary">Criar novo funcionario</a>
            </div>
        </div>
    </div>
</div>