                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <form action="router.php?c=funcionario&a=index" method="post" class="input-group input-group-sm">
                                    <a class="pt-1 mx-2" href="./router.php?c=funcionario&a=index">Limpar Filtro</a>
