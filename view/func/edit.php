        ...
        <form action="router.php?c=func&a=store" method="post"
            ...
            <div class="row mb-5">
                ...
                <div class="col-6 mb-2">
                    ...
                    <input type="number" name="func_telefone" id="func_telefone" class="form-control"
                           required maxlength="9" value="<?=$func->telefone?>">
                    <?php if(isset($func->errors)) {?>
                        <div class="invalid-feedback">
                ...
                <div class="col-6 mb-2">
                    ...
                    <input type="number" name="func_NIF" id="func_NIF" class="form-control" required maxlength="9"
                           value="<?=$func->nif?>">
                    <?php if(isset($func->errors)) {?>
                        <div class="invalid-feedback">
                            <?= $func->errors->on('nif') ?>
                ...
                <div class="col-4 mb-2">
                    ...
                    <input type="text" name="func_morada" id="func_morada" class="form-control"
                           required maxlength="100" value="<?=$func->morada?>" >
                    <?php if(isset($func->errors)) {?>
                        <div class="invalid-feedback">
                ...
                <div class="col-4 mb-2">
                    ...
                    <input type="text" name="func_codigoPostal" id="func_codigoPostal"
                           class="form-control" required maxlength="8"
                        value="<?=$func->codigopostal?>" ?>>
                    <?php if(isset($func->errors)) {?>
                        <div class="invalid-feedback">
                            <?= $func->errors->on('codigopostal') ?>
                        </div>
                    <?php } ?>
                </div>
                <div class="col-4 mb-2">
