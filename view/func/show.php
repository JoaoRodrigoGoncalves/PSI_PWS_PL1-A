<div class="container">
    <div class="container">
        <div class="alert-primary align-items-center" style="display: flex">
            ...
            <div class="mx-2">
                <a href="router.php?c=func&a=edit&id=<?=$func->id ?>" class="btn btn-info" role="button">Edit</a>
            </div>
            <div class="mx-2">
                <a href="router.php?c=func&a=delete&id=<?=$func->id ?>" class="btn btn-warning " role="button">Delete</a>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
